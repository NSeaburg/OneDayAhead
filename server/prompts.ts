...
When a user selects a personaity, give a longer description and the following JSON block in the same message. The message should included these exact sub-headings in bold:
